...
class ValueRepository
  ...
  def update
    ...
    file_data["data"].each do |var|
      ...
      import_value.id = var[0].to_i
      import_value.time = Time.now.to_i
      ...
      import_value.profitmargin = (import_value.avgHighPrice - import_value.avgLowPrice)-(import_value.avgHighPrice/100).to_i
